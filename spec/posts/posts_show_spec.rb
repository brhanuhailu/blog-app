...
RSpec.describe 'posts/show', type: :feature do
  before(:each) do
    @user = [
      User.create(
        name: 'Brhanu',
        photo: 'https://fastly.picsum.photos/id/341/200/400.jpg?hmac=nHjdfC20Ag4oSRf8hOKqlWEhraq-Jqf_wn4S_rdM1oA',
    ...
    @first_post = Post.create(
      author: @first_user,
      title: 'Hello',
      text: 'This is my first post from Brhanu',
      comments_counter: 1,
      likes_counter: 1
    )

    @first_comment = Comment.create(post: @first_post, author: @first_user, text: 'First comment for Brhanu')
    @second_comment = Comment.create(post: @first_post, author: @first_user, text: 'Second comment for Brhanu')
    @third_comment = Comment.create(post: @first_post, author: @first_user, text: 'Third comment for brhanu')
  ...
  it 'shows username  commenters on the post' do
