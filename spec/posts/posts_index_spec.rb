...
RSpec.describe 'posts/index', type: :feature do
  before(:each) do
    ...
    @first_post = Post.create(
      author: @first_user,
      title: 'Hello',
      text: 'software Engineer is a good job',
      comments_counter: 1,
      likes_counter: 1
    )
    @second_post = Post.create(
      author: @first_user,
      title: 'How are you?',
      text: 'This is my second post in design softwares',
      comments_counter: 0,
      likes_counter: 1
    )
    @first_comment = Comment.create(post: @first_post, author: @first_user, text: 'Comment is good to me')
    @second_comment = Comment.create(post: @second_post, author: @first_user, text: 'This is my second command')
