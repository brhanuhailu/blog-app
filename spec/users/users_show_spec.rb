...
RSpec.describe 'users/show', type: :feature do
  before(:each) do
    @user = [
      User.create(name: 'Brhanu', photo: 'https://picsum.photos/300/200', bio: 'Software Engineer Ethiopia',
                  posts_counter: 2),
      User.create(name: 'Amen', photo: 'https://picsum.photos/300/200', bio: 'Software Engineer from Nigeria',
                  posts_counter: 3)
    ]
    @first_user = User.first
    @first_post = Post.create(author: @first_user, title: 'Hello', text: 'This is my first post from Brhanu',
                              comments_counter: 1, likes_counter: 1)
    @second_post = Post.create(author: @first_user, title: 'How are you doing?', text: 'This is my second post from Brhanu',
                               comments_counter: 0, likes_counter: 1)
    @third_post = Post.create(author: @first_user, title: 'I hope evey thing is going well', text: 'This is my third post from Brhanu',
                              comments_counter: 0, likes_counter: 1)
